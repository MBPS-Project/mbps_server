...
public class Config {
	...
	public static final int MIN_CONFIRMATIONS_SMALL_TRANSACTIONS = 1; // recommended: 6
	public static final int MIN_CONFIRMATIONS_BIG_TRANSACTIONS = 6; //recommended: 12
